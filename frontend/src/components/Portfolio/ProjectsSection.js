              ...
              <div className="project-card-slide revealed">
                ...
                <div className="project-details">
                  <ul className="project-bullets">
                    <li>Engineered a geospatial site-recommendation system for EV charging in India, fusing population-density rasters, 39K+ existing charging stations, and 3M+ OpenStreetMap road/POI records into a 13,122-location demand feature set, served via a Flask API and React frontend.</li>
                    <li>Implemented a KD-tree-accelerated greedy k-center optimization algorithm, processing 10K candidate locations in under 40 ms and accelerating nearest-neighbor queries by 131× over brute-force search.</li>
                  </ul>
